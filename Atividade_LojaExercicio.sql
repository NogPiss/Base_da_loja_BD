...
insert into cliente (cod_clie, nome_clie, endereco, cidade, cep, uf, cnpj) values(110, 'Jorge', 'Rua Caiapó 13', 'Curituba', 30078500, 'PR', '14512764/9834-9');
...
insert into vendedor (cod_ven, nome_vend, salario_fixo, comissao) values(209, 'José', 1800.00, 'C');
insert into vendedor (cod_ven, nome_vend, salario_fixo, comissao) values(111, 'Carlos', 2490.00, 'A');
insert into vendedor (cod_ven, nome_vend, salario_fixo, comissao) values(11, 'João', 2780.00, 'C');
insert into vendedor (cod_ven, nome_vend, salario_fixo, comissao) values(240, 'Antônio', 9500.00, 'C');
...
insert into vendedor (cod_ven, nome_vend, salario_fixo, comissao) values(101, 'João', 2650.00, 'C');
insert into vendedor (cod_ven, nome_vend, salario_fixo, comissao) values(310, 'Josias', 870.00, 'B');
insert into vendedor (cod_ven, nome_vend, salario_fixo, comissao) values(250, 'Maurício', 2930.00, 'B');
